export const LocaleMessages = {
  ...
  "NearIntentsDeposit.flow.sent": "Swap in progress",
  "NearIntentsDeposit.flow.approving": "Approve USDC spending …",
  "NearIntentsDeposit.flow.confirmDeposit": "Confirm deposit in wallet …",
  "NearIntentsDeposit.flow.preparing": "Preparing deposit …",
  "NearIntentsDeposit.flow.depositing": "Deposit USDC to trading account",
  "NearIntentsDeposit.flow.sending": "Sending",
  "NearIntentsDeposit.flow.expected": "Expected",
